# 🧠 4択クイズアプリ v0.1 - プログラム版追加！

## 🎯 新機能: プログラム4択クイズアプリ

**📝 program-4choice-quiz.html** - プログラミングの知識をテストする4択問題を30問収録！

### ✨ 主な機能
- **🔄 適応学習システム**: 正解率に応じて出題頻度を自動調整
- **📊 詳細統計機能**: 問題ごとの正解率を表示・エクスポート可能
- **⚡ 高速回答**: 0.2秒で自動的に次の問題へ進む
- **💾 データ永続化**: LocalStorageで記録を保存（ブラウザ閉じても残る）
- **📱 レスポンシブデザイン**: PC・スマホ・タブレットで美しく表示
- **🔒 セキュアな動作**: HTMLファイル1つで完結、外部通信なし

### 🎮 使い方
1. `program-4choice-quiz.html` をブラウザで開く
2. 「クイズを始める」ボタンをクリック
3. 4択問題に回答（1回5問ずつ）
4. 結果を確認、統計データで弱点を把握
5. 「ログ出力」で詳細な記録をダウンロード

### 📚 学習コンテンツ
JavaScript、HTML、CSS基本から中級レベルまで30問を収録：
- 変数宣言・関数定義
- HTML要素・CSS設計
- DOM操作・イベント処理
- データ構造・制御構文
